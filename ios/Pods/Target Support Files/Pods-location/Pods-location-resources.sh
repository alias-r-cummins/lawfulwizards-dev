...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/MapboxMaps/Sources/MapboxMaps/Location/Puck/IndicatorAssets.xcassets"
  install_resource "${PODS_ROOT}/MapboxMaps/Sources/MapboxMaps/MapboxMaps.json"
