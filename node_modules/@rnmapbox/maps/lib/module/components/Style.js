...
function asLayerComponent(layer) {
  ...
  return /*#__PURE__*/React.createElement(LayerComponent, _extends({
    key: layer.id,
    id: layer.id
  }, layerProps));
}
...
function getVectorSource(id, source) {
  ...
  return /*#__PURE__*/React.createElement(VectorSource, _extends({
    key: id,
    id: id
  }, sourceProps));
}
function getRasterSource(id, source) {
  ...
  return /*#__PURE__*/React.createElement(RasterSource, _extends({
    key: id,
    id: id
  }, sourceProps));
}
function getImageSource(id, source) {
  ...
  return /*#__PURE__*/React.createElement(ImageSource, _extends({
    key: id,
    id: id
  }, sourceProps));
}
function getShapeSource(id, source) {
  ...
  return /*#__PURE__*/React.createElement(ShapeSource, _extends({
    key: id,
    id: id
  }, sourceProps));
}
...
const Style = props => {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, sourceComponents, layerComponents);
};
