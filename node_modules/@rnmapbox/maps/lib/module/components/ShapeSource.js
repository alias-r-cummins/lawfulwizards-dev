...
export class ShapeSource extends NativeBridgeComponent(AbstractSource, NATIVE_MODULE_NAME) {
  ...
  async features() {
    ...
    const res = await this._runNativeCommand('features', this._nativeRef, getFilter(filter));
    if (isAndroid()) {
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement(RCTMGLShapeSource, props, cloneReactChildrenWithProps(this.props.children, {
