...
export const normalIcon = (showsUserHeadingIndicator, heading) => [/*#__PURE__*/React.createElement(CircleLayer, {
...
}), ...(showsUserHeadingIndicator && heading !== null ? [HeadingIndicator({
  heading
})] : [])];
