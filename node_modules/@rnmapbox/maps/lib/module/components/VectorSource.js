 ...
 */
class VectorSource extends NativeBridgeComponent(AbstractSource, NATIVE_MODULE_NAME) {
  static defaultProps = {
  ...
  async features() {
    ...
    const res = await this._runNativeCommand('features', this._nativeRef, [layerIDs, getFilter(filter)]);
    if (isAndroid()) {
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement(RCTMGLVectorSource, _extends({
...
const RCTMGLVectorSource = requireNativeComponent(NATIVE_MODULE_NAME);
