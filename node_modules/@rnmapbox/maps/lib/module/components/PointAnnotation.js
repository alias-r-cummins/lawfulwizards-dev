...
class PointAnnotation extends NativeBridgeComponent(React.PureComponent, NATIVE_MODULE_NAME) {
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement(RCTMGLPointAnnotation, props, this.props.children);
  }
}
...
const RCTMGLPointAnnotation = requireNativeComponent(NATIVE_MODULE_NAME);
