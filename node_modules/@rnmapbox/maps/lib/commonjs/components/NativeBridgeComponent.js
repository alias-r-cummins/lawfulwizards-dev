...
const NativeBridgeComponent = (Base, nativeModuleName) => class extends Base {
  constructor() {
    super(...arguments);
    _defineProperty(this, "_nativeModuleName", void 0);
    _defineProperty(this, "_onAndroidCallback", void 0);
    _defineProperty(this, "_callbackMap", void 0);
    _defineProperty(this, "_preRefMapMethodQueue", void 0);
  ...
  _runNativeCommand(methodName, nativeRef) {
    ...
    if ((0, _utils.isAndroid)()) {
      return new Promise((resolve, reject) => {
        ...
        (0, _utils.runNativeCommand)(this._nativeModuleName, methodName, nativeRef, args);
      });
    }
