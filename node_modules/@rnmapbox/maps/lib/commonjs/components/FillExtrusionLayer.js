...
class FillExtrusionLayer extends _AbstractLayer.default {
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(RCTMGLFillExtrusionLayer, _extends({
...
const RCTMGLFillExtrusionLayer = (0, _reactNative.requireNativeComponent)(NATIVE_MODULE_NAME, FillExtrusionLayer, {
  nativeOnly: {
    reactStyle: true
  }
});
