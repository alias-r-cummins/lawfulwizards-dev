...
const NATIVE_MODULE_NAME = 'RCTMGLRasterLayer';
...
class RasterLayer extends _AbstractLayer.default {
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(RCTMGLRasterLayer, _extends({
...
const RCTMGLRasterLayer = (0, _reactNative.requireNativeComponent)(NATIVE_MODULE_NAME, RasterLayer, {
  nativeOnly: {
    reactStyle: true
  }
});
