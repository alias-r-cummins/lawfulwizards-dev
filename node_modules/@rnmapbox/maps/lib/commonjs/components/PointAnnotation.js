...
const NATIVE_MODULE_NAME = 'RCTMGLPointAnnotation';
...
class PointAnnotation extends (0, _NativeBridgeComponent.default)(_react.default.PureComponent, NATIVE_MODULE_NAME) {
  constructor(props) {
    super(props);
    _defineProperty(this, "_nativeRef", null);
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(RCTMGLPointAnnotation, props, this.props.children);
  }
}
_defineProperty(PointAnnotation, "defaultProps", {
  anchor: {
    x: 0.5,
    y: 0.5
  },
...
const RCTMGLPointAnnotation = (0, _reactNative.requireNativeComponent)(NATIVE_MODULE_NAME);
var _default = PointAnnotation;
