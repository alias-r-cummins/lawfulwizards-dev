...
class FillLayer extends _AbstractLayer.default {
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(RCTMGLFillLayer, _extends({
...
const RCTMGLFillLayer = (0, _reactNative.requireNativeComponent)(NATIVE_MODULE_NAME, FillLayer, {
  nativeOnly: {
    reactStyle: true
  }
});
