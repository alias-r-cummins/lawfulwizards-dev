...
const NativeModule = _reactNative.NativeModules.MGLModule;
...
const NATIVE_MODULE_NAME = 'RCTMGLCamera';
...
const Camera = /*#__PURE__*/(0, _react.memo)( /*#__PURE__*/(0, _react.forwardRef)((props, ref) => {
  ...
  const buildNativeStop = (0, _react.useCallback)(function (stop) {
    ...
    _nativeStop.paddingTop = ((_stop$padding = stop.padding) === null || _stop$padding === void 0 ? void 0 : _stop$padding.paddingTop) ?? ((_stop$bounds = stop.bounds) === null || _stop$bounds === void 0 ? void 0 : _stop$bounds.paddingTop) ?? 0;
    _nativeStop.paddingRight = ((_stop$padding2 = stop.padding) === null || _stop$padding2 === void 0 ? void 0 : _stop$padding2.paddingRight) ?? ((_stop$bounds2 = stop.bounds) === null || _stop$bounds2 === void 0 ? void 0 : _stop$bounds2.paddingRight) ?? 0;
    _nativeStop.paddingBottom = ((_stop$padding3 = stop.padding) === null || _stop$padding3 === void 0 ? void 0 : _stop$padding3.paddingBottom) ?? ((_stop$bounds3 = stop.bounds) === null || _stop$bounds3 === void 0 ? void 0 : _stop$bounds3.paddingBottom) ?? 0;
    _nativeStop.paddingLeft = ((_stop$padding4 = stop.padding) === null || _stop$padding4 === void 0 ? void 0 : _stop$padding4.paddingLeft) ?? ((_stop$bounds4 = stop.bounds) === null || _stop$bounds4 === void 0 ? void 0 : _stop$bounds4.paddingLeft) ?? 0;
    return _nativeStop;
  ...
  const _fitBounds = function (ne, sw) {
    let paddingConfig = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
  ...
  const _flyTo = function (_centerCoordinate) {
  ...
  const _moveTo = function (_centerCoordinate) {
  ...
  const _zoomTo = function (_zoomLevel) {
    let _animationDuration = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 2000;
    setCamera({
      type: 'CameraStop',
  ...
  return /*#__PURE__*/_react.default.createElement(RCTMGLCamera, {
    testID: 'Camera',
    ref: nativeCamera,
    stop: nativeStop,
...
const RCTMGLCamera = (0, _reactNative.requireNativeComponent)(NATIVE_MODULE_NAME);
