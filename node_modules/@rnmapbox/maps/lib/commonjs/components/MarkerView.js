...
const Mapbox = _reactNative.NativeModules.MGLModule;
const NATIVE_MODULE_NAME = 'RCTMGLMarkerView';
...
class MarkerView extends _react.default.PureComponent {
  constructor() {
    super(...arguments);
    _defineProperty(this, "__idForPointAnnotation", void 0);
  }
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(RCTMGLMarkerView, {
      style: [{
        flex: 0,
...
const RCTMGLMarkerView = (0, _reactNative.requireNativeComponent)(NATIVE_MODULE_NAME);
