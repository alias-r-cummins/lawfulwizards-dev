...
const MapboxGLOfflineManager = _reactNative.NativeModules.MGLOfflineModule;
const OfflineModuleEventEmitter = new _reactNative.NativeEventEmitter(MapboxGLOfflineManager);
