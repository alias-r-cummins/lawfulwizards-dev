...
const MapboxOfflineManager = _reactNative.NativeModules.MGLOfflineModule;
const OfflineModuleEventEmitter = new _reactNative.NativeEventEmitter(MapboxOfflineManager);
  ...
  async subscribe(packName, progressListener, errorListener) {
    ...
    if ((0, _utils.isFunction)(progressListener)) {
      if (totalProgressListeners === 0) {
        this.subscriptionProgress = OfflineModuleEventEmitter.addListener(MGLModule.OfflineCallbackName.Progress, this._onProgress);
      }
    ...
    if ((0, _utils.isFunction)(errorListener)) {
      if (totalErrorListeners === 0) {
        this.subscriptionError = OfflineModuleEventEmitter.addListener(MGLModule.OfflineCallbackName.Error, this._onError);
      }
