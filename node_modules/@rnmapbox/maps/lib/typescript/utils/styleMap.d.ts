...
export declare const TerrainLayerStyleProp: PropTypes.Requireable<PropTypes.InferProps<{
    /**
     ...
     * @requires source
     */
    exaggeration: PropTypes.Requireable<NonNullable<number | any[] | null | undefined>>;
    /**
     * The transition affecting any changes to this layer’s exaggeration property.
     */
    exaggerationTransition: PropTypes.Requireable<PropTypes.InferProps<{
        duration: PropTypes.Requireable<number>;
        delay: PropTypes.Requireable<number>;
    }>>;
}>>;
